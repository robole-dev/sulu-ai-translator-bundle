...
export default class AITranslatorToolbarAction extends AbstractListToolbarAction {
    ...
    constructor(props) {
        ...
        this.disposer = reaction(
            () => [translateQueueStore.activeItemsLength, translateQueueStore.totalItemsLength], 
            () => {
                this.updateState(translateQueueStore.activeItemsLength, translateQueueStore.totalItemsLength);
            }
        );
    }
    ...
    updateState(activeItemsLength, totalItemsLength) {
        ...
        this.setButtonProgress(parseInt(
    ...
    handleClick = () => {
        if (
            ...
            confirm(
                translate("app.translator_bulk_translate_confirm")
            ) === false
        ) {
            return;
        }
